...
class Tutorial extends Component {
    ...
    componentDidMount() { //since we're using router parameters we have to import withRouter
    ...
    onChangeDescription(e) {
        ...
        this.setState(function(prevState) {
            return {
                currentTutorial: {...prevState.currentTutorial, description: description}
            };
        });
    }
        ...
        TutorialDataService.update(this.state.currentTutorial._id, data)
            .then(response=> {
                this.setState(prevState=> ({
                    currentTutorial: {...prevState.currentTutorial, published: status}
                }));
                console.log(response.data);
            })
            .catch(e=> {
    ...
    updateTutorial() {
        TutorialDataService.update(this.state.currentTutorial._id, this.state.currentTutorial)
            .then(response=> {
                console.log(response.data);
